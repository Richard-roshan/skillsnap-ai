...
class ApiService {
  ...
  static const String wsUrl = 'ws://172.20.10.3:8000';
  ...
  static Future<Map<String, dynamic>> fetchCourseLessons(int courseId) async {
    ...
    final mockData = {
      1: [
        {"id": 101, "course_id": 1, "lesson_title": "1. Introduction to FastAPI & Async Python Event Loops", "lesson_description": "Setting up Python, Uvicorn ASGI server, async def, and event loop execution.", "video_url": "tLKKmouUams", "duration": "12:30", "lesson_order": 1, "is_free": true},
        {"id": 102, "course_id": 1, "lesson_title": "2. Pydantic v2 Schemas & Request Data Validation", "lesson_description": "Building strict BaseModel data validation schemas with Field and from_attributes.", "video_url": "Vj-iLBl7nAc", "duration": "18:45", "lesson_order": 2, "is_free": true},
        {"id": 103, "course_id": 1, "lesson_title": "3. SQLAlchemy 2.0 ORM & Async PostgreSQL Integration", "lesson_description": "Connecting FastAPI to relational databases using AsyncSession and Alembic.", "video_url": "0sOvCWFmrtA", "duration": "25:10", "lesson_order": 3, "is_free": true},
        {"id": 104, "course_id": 1, "lesson_title": "4. JWT OAuth2 Authentication & Security Middleware", "lesson_description": "Implementing OAuth2 bearer tokens, bcrypt password hashing, and CORS headers.", "video_url": "gQddtTdmG_8", "duration": "21:15", "lesson_order": 4, "is_free": true},
        {"id": 105, "course_id": 1, "lesson_title": "5. Real-Time WebSockets & Background Worker Tasks", "lesson_description": "Broadcasting live WebSocket events to mobile clients and processing Celery jobs.", "video_url": "vLqTf2b6GZw", "duration": "30:00", "lesson_order": 5, "is_free": true}
      ],
      2: [
        {"id": 201, "course_id": 2, "lesson_title": "1. Flutter SDK Setup & Advanced Dart Fundamentals", "lesson_description": "Dart OOP, extension methods, records, patterns, and async/await Futures.", "video_url": "pTJJsmejUOQ", "duration": "15:00", "lesson_order": 1, "is_free": true},
        {"id": 202, "course_id": 2, "lesson_title": "2. Mobile UI Layouts, Slivers & Custom Scroll View", "lesson_description": "Building complex responsive mobile layouts using SliverAppBar and CustomScrollView.", "video_url": "fq4N0hgOWzU", "duration": "22:40", "lesson_order": 2, "is_free": true},
        {"id": 203, "course_id": 2, "lesson_title": "3. Reactive State Management with Provider & Riverpod", "lesson_description": "Managing app-wide reactive state using ChangeNotifier and Consumer widgets.", "video_url": "x0uinJvhNxI", "duration": "28:15", "lesson_order": 3, "is_free": true},
        {"id": 204, "course_id": 2, "lesson_title": "4. REST API Integration, HTTP Client & Networking", "lesson_description": "Connecting Flutter to backend REST endpoints with JSON parsing and error handling.", "video_url": "1xipg02Wu8s", "duration": "19:50", "lesson_order": 4, "is_free": true},
        {"id": 205, "course_id": 2, "lesson_title": "5. Local Persistence with SQLite, Room & Hive DB", "lesson_description": "Storing user preferences and offline database cache using sqflite and Hive.", "video_url": "VPvVD8t02U8", "duration": "26:30", "lesson_order": 5, "is_free": true}
      ],
      3: [
        {"id": 301, "course_id": 3, "lesson_title": "1. Figma Fundamentals & Auto Layout 5.0 Masterclass", "lesson_description": "Mastering auto-layout gap, padding, wrap layout, and responsive constraints.", "video_url": "c9Wg6Cb_YlU", "duration": "14:20", "lesson_order": 1, "is_free": true},
        {"id": 302, "course_id": 3, "lesson_title": "2. Design Systems, Color Tokens & Typography Scale", "lesson_description": "Building reusable UI component libraries with Figma Variables and design tokens.", "video_url": "HZuk6Wkx_Eg", "duration": "20:00", "lesson_order": 2, "is_free": true},
        {"id": 303, "course_id": 3, "lesson_title": "3. Micro-Interactions, Smart Animate & Variants", "lesson_description": "Designing fluid button hover states, modal spring transitions, and interactive prototypes.", "video_url": "YqQx75OPRa0", "duration": "17:30", "lesson_order": 3, "is_free": true},
        {"id": 304, "course_id": 3, "lesson_title": "4. User Research, Wireframing & Information Architecture", "lesson_description": "Conducting user interviews, mapping user journeys, and building low-fi wireframes.", "video_url": "CD1Y2DmL5JM", "duration": "24:10", "lesson_order": 4, "is_free": true},
        {"id": 305, "course_id": 3, "lesson_title": "5. WCAG 2.2 Accessibility, Color Contrast & Guidelines", "lesson_description": "Ensuring WCAG AA/AAA accessibility compliance across web and mobile viewports.", "video_url": "b24m2nB7b4k", "duration": "16:45", "lesson_order": 5, "is_free": true}
      ]
    };
